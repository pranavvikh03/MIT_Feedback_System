...
<div class="container">
   <?php echo form_open(base_url('forms/update3'),['class'=>'form-horizontal']); ?>
   <fieldset>
   ...
   <div class="row">
       <div class="col-lg-6">
         <div class="form-group">
            ...
            <div class="col-lg-8">
              <?php echo form_input(['name'=>'ch4','class'=>'form-control','placeholder'=>'Enter choice 4 ','value'=>set_value('que',$res->choice4)]); ?>
            </div>
          </div>
        </div>
   </div>
   ...
   <div class="row">
       <div class="col-lg-6">
         <div class="form-group">
            ...
            <div class="col-lg-8">
              <?php echo form_input(['name'=>'ch5','class'=>'form-control','placeholder'=>'Enter choice 5','value'=>set_value('que',$res->choice5)]); ?>
            </div>
          </div>
        </div>
   </div>
